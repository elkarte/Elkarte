...
abstract class Database
{
	 ...
	 * @param resource $connection = null
	 */
	abstract function smf_db_insert_id($table, $field = null, $connection = null);
	 ...
	 * @param resource $connection = null
	 */
	abstract function smf_db_insert($method = 'replace', $table, $columns, $data, $keys, $disable_trans = false, $connection = null);
