...
function template_select()
{
	...
	<div id="split_topics">
		<form action="', $scripturl, '?action=splittopics;sa=splitSelection;board=', $context['current_board'], '.0" method="post" accept-charset="UTF-8">
			<div id="not_selected" class="floatleft">
				...
				</div>', template_pagesection(false, '', ['page_index_markup' => $context['not_selected']['page_index'], 'page_index_id' => 'pageindex_not_selected']), '
	...
	echo '
			...
			<div id="selected" class="floatright">
				...
				</div>', template_pagesection(false, '', ['page_index_markup' => $context['selected']['page_index'], 'page_index_id' => 'pageindex_selected']), '
	...
	echo '
			...
			<div class="submitbutton clear_right">
				...
				<input type="submit" style="flex: 0 0 100%;" value="', $txt['split_topic'], '" />
				<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
			</div>
		</form>
	</div>
