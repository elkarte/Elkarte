...
class OpenID
{
	...
	public function revalidate()
	{
		...
		{
			$this->validate(User::$settings['openid_uri'], false, null, 'revalidate');
		}
	...
	public function getServerInfo($openid_url)
	{
		...
		{
			throw new Exception('openid_server_bad_response');
		}
	...
	protected function long_to_binary($value)
	{
		...
		if ($cmp < 0)
		{
			throw new Exception('Only non-negative integers allowed.');
		}
