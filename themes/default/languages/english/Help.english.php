...
$helptxt['time_format'] = '<strong>Time Format</strong><br />
	...
	The conventions follow PHP\'s strftime function and are described as below (more details can be found at <a href="http://www.php.net/manual/function.Util::strftime.php" target="_blank" class="new_win">php.net</a>).<br />
	<br />
...
$helptxt['enableVideoEmbeding'] = 'This allows automatic conversion of standard URLs into an embedded video when the post is viewed.  Currently supports YouTube, Vimeo and Dailymotion video links';
