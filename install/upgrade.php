...
// Prevent access to the upgrader when a bootstrap completion lock exists, unless explicitly overridden
if (file_exists(dirname(__DIR__) . '/bootstrapcompleted.lock') && !defined('IGNORE_INSTALL_DIR'))
{
	...
	echo '<p>The upgrader is disabled because a bootstrap completion lock was found. If you need to run the upgrader, remove the file <code>bootstrapcompleted.lock</code> from the forum root.</p>';
	echo '</body></html>';
	die;
}
