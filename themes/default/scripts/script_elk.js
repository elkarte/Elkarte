...
/**
 * Controls an error box by adding or removing errors
 */
...
errorbox_handler.prototype.checkErrors = function (add = false)
{
	...
	this.oError_box.attr("class", "infobox");
...
errorbox_handler.prototype.addError = function (error_elem, error_code)
{
	if (error_elem.length === 0)
	{
		...
		$(document.getElementById(this.opt.error_box_id + "_list")).append("<li style=\"display:none;\" id='" + this.opt.error_box_id + "_" + error_code + "'>" + error_txts[error_code] + "</li>");
