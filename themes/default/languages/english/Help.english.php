...
$helptxt['make_email_viewable'] = 'If this option is enabled, users\' e-mail addresses will be publicly viewable on the forum instead of being hidden to normal members and guests. Enabling this will put your users at greater risk of being victims of spam as a result of email harvesters visiting your forum. Note this setting does not override the user setting for hiding their email address from users. Enabling this setting is <strong>not</strong> recommended.';
