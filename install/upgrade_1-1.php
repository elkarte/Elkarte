			...
			array(
				...
				'function' => function()
				{
					$this->db->insert('replace',
						...
						array(
							array('cust_gender', 'Gender', 'Your gender', 'radio', 15, '{"undisclosed":"undisclosed","male":"male","female":"female","genderless":"genderless","nonbinary":"nonbinary","transgendered":"transgendered"}', '', 0, 1, 'forumprofile', 0, 1, 0, 0, 'undisclosed', '<i class="icon i-{INPUT}" title="{INPUT}"><s>{INPUT}</s></i>', 0, 0, 0),
