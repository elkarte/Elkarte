	...
	if ($context['can_reply'] && !empty($options['display_quick_reply']))
	{
		...
		if ($context['user']['is_guest'])
			echo '
							<dl>
								<dt>
									<strong><label for="guestname">', $txt['name_colon'], '</label></strong> <input type="text" name="guestname" id="guestname" value="', $context['name'], '" size="25" class="input_text" tabindex="', $context['tabindex']++, '" />
								</dd>
								<dt>
									<strong><label for="email">', $txt['email_colon'], '&nbsp;</label></strong> <input type="text" name="email" id="email" value="', $context['email'], '" size="25" class="input_text" tabindex="', $context['tabindex']++, '" />
								</dd>
							</dl>';
