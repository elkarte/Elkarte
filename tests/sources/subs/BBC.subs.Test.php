...
Should be an empty line in between.',
			...
			array(
				...
				'<blockquote class="bbc_quote"><cite>Quote</cite>This is a quote<blockquote class="bbc_quote bbc_alternate_quote"><cite>Quote</cite>of a quote</blockquote></blockquote>',
			),
			array(
				'Quoting is a pain 2',
