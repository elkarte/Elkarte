...
class TestMenu extends PHPUnit_Framework_TestCase
{
	...
	protected $test_include_data = array();
	protected $menu;
	...
	public function testOptions()
	{
		...
		$this->test_include_data = $this->menu->prepareMenu();
		...
		$this->assertSame($expected, $this->test_include_data);
	}
	...
	public function testMenuAdd()
	{
		...
		$this->assertEquals('Area6 Label', $this->test_include_data['label']);
	}
}