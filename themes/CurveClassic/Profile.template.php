		...
		echo '
			<div class="groupmembership">
				...
				<div class="roundframe">
					...
					<textarea name="reason" rows="4" cols="80" style="' . (isBrowser('is_ie8') ? 'width: 635px; max-width: 99%; min-width: 99%' : 'width: 99%') . ';"></textarea>
	...
	else
	{
		...
		if (!empty($context['groups']['available']))
		{
			...
			foreach ($context['groups']['available'] as $group)
			{
				...
				if ($group['type'] == 3)
					echo '
							<a class="button_link" href="', $scripturl, '?action=profile;save;u=', $context['id_member'], ';area=groupmembership;', $context['session_var'], '=', $context['session_id'], ';gid=', $group['id'], ';', $context[$context['token_check'] . '_token_var'], '=', $context[$context['token_check'] . '_token'], '">', $txt['join_group'], '</a>';
				elseif ($group['type'] == 2 && $group['pending'])
					echo '
							', $txt['approval_pending'];
				elseif ($group['type'] == 2)
					echo '
							<a class="button_link" href="', $scripturl, '?action=profile;u=', $context['id_member'], ';area=groupmembership;request=', $group['id'], '">', $txt['request_group'], '</a>';
...
/**
 * Profile block that shows: Avatar, Title, blurb, group info, number of posts, karma
 * Has links to show posts and attachments
 */
		...
		<div class="windowbg">
			<div class="content">
				<div id="basicinfo">
					...
					<div class="clear">
						<em>', $settings['use_image_buttons'] ? '<img style="vertical-align:middle" src="' . $context['member']['online']['image_href'] . '" alt="' . $context['member']['online']['text'] . '" />' : $context['member']['online']['text'], $settings['use_image_buttons'] ? '<span class="smalltext"> ' . $context['member']['online']['text'] . '</span>' : '', '</em>
					</div>
				</div>

				<div class="content profileblock">
					<dl>
...
/**
 * Profile block to show additional user details including:
 * age, gender, location, join date, localization details (language and time)
	...
	echo '
		<div class="windowbg">
			...
			echo '
					...
					<dd>', $context['member']['age'] . ($context['member']['today_is_birthday'] ? '&nbsp;<img src="' . $settings['images_url'] . '/cake.png" alt="" style="vertical-align:middle;"/>' : ''), '</dd>';
...
/**
 * Show the custom profile fields for placement '0'
 */
function template_profile_block_user_customprofileinfo()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<img src="', $settings['images_url'], '/icon.png" alt="" class="icon"/>&nbsp;';
				if ($context['user']['is_owner'])
					echo '
					<a href="', $scripturl ,'?action=profile;area=forumprofile;u=', $context['member']['id'], '">' , $txt['additional_info'] , '</a>';
				else
 ...
 * Shows custom profile fields of type '1'
 */
function template_profile_block_contact()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<img src="', $settings['images_url'], '/post/wireless.png" alt="" class="icon"/>&nbsp;', $txt['profile_contact'], '
			</h3>
		</div>
		...
		<div class="windowbg">
			...
			// Can they add this member as a buddy, or can they de-friend them instead?
			if (!empty($context['can_have_buddy']) && !$context['user']['is_owner'])
			{
				...
				echo '
					<dt><img src="', $settings['images_url'], '/icons/online.png" alt="" class="icon" /></dt>
					<dd>
 ...
 * Shows custom profile fields of type '2', you know the ones that go with the signature line :D
 */
function template_profile_block_other_info()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<img src="', $settings['images_url'], '/post/question.png" alt="" class="icon"/>&nbsp;';
				if ($context['user']['is_owner'])
					echo '
					<a href="', $scripturl ,'?action=profile;area=forumprofile;u=', $context['member']['id'], '">' , $txt['profile_more'] , '</a>';
				else
					echo $txt['profile_more'];
...
/**
 * Show any warnings on this user and allows for editing of it
 * Can approve members
...
function template_profile_block_moderation()
{
	...
	// Can they do view warnings or approve members ?
	if (($context['can_view_warning'] && $context['member']['warning']) || (!empty($context['activate_message']) || !empty($context['member']['bans'])))
	{
		echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<img src="', $settings['images_url'], '/post/wireless.png" alt="" class="icon"/>&nbsp;', $txt['profile_moderation'], '
			</h3>
		</div>
		...
		if ($context['can_view_warning'] && $context['member']['warning'])
		{
			echo '
				<dl>
					<dt><strong>', $txt['profile_warning_level'], ': </strong></dt>
					<dd>
			...
			if (!empty($context['warning_status']))
				echo '
					<span class="alert">(', $context['warning_status'], ')</span>';
...
function template_profile_block_attachments()
{
	...
	<div class="cat_bar">
		<h3 class="catbg">
			<img src="', $settings['images_url'], '/image.png" alt="" class="icon"/>&nbsp;
