...
function Display()
{
	...
	if (!empty($context['topic_derived_from']))
		$context['previous_next'] .= ' - <a href="' . $scripturl . '?msg=' . $context['topic_derived_from']['derived_from'] . '">' . sprintf($txt['topic_derived_from'], '<em>' . shorten_string($context['topic_derived_from']['subject'], $modSettings['subject_length'])) . '</em></a>';
