...
$db_table->db_create_table('{db_prefix}members',
	array(
		...
		array('name' => 'enable_2fa',			'type' => 'tinyint', 'size' => 1, 'default' => 0),
	),
	array(
...
$db->insert('ignore',
	...
	array(
		...
		array(0, 'profile_server_avatar'),
		array(0, 'profile_upload_avatar'),
		array(0, 'profile_remote_avatar'),
		array(0, 'profile_gravatar'),
		...
		array(2, 'profile_server_avatar'),
		array(2, 'profile_upload_avatar'),
		array(2, 'profile_remote_avatar'),
		array(2, 'profile_gravatar'),
...
$db->insert('ignore',
	...
	array(
		...
		array('avatar_max_height_external', '65'),
		array('avatar_max_width_external', '65'),
		array('avatar_action_too_large', 'option_html_resize'),
		array('avatar_max_height_upload', '65'),
		array('avatar_max_width_upload', '65'),
		array('avatar_resize_upload', '1'),
...
$db_table->db_create_table('{db_prefix}subscriptions',
	array(
