 ...
 */
class CalendarEventTest extends ElkArteCommonSetupTest
{
	...
	public static function tearDownAfterClass(): void
	{
		...
		rename(BOARDDIR . '/tests/ElkArte/CalendarEventTest.php', BOARDDIR . '/tests/ElkArte/CalendarEventTest.tmp');
	}
