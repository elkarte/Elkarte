 ...
 * @return string|false
 */
function read_tgz_file2($gzfilename, $destination, $single_file = false, $overwrite = false, $files_to_extract = null)
{
	// From a web site
 ...
 * @return string|false
 */
function read_tgz_data2($data, $destination, $single_file = false, $overwrite = false, $files_to_extract = null)
{
 ...
 */
function read_zip_data2($data, $destination, $single_file = false, $overwrite = false, $files_to_extract = null)
{
	umask(0);
