...
$txt['theme_install_file'] = 'From an archive: <i>(e.g. .zip, .tar.gz)</i>';
...
$txt['site_slogan'] = '<u>Site Slogan</u>';
$txt['site_slogan_desc'] = 'Add your own text for a slogan here. It will replace the default logo.';
$txt['header_layout'] = '<u>Header Layout</u>';

$txt['header_layout_desc'] = '<i>(select one of three Logo layouts for the header)</i>
<br /><i><b>&emsp;Default Position</b></i> &hellip;<br />&emsp;&emsp;Logo is placed on the right and the site name on the left.
<br /><i><b>&emsp;Logo Only</b></i> &hellip;<br />&emsp;&emsp;Only the logo is displayed in a centered position.
<br /><i><b>&emsp;Logo To The Left</b></i> &hellip;<br />&emsp;&emsp;Logo is placed on the left and the site name on the right.';
...
$txt['enable_news_desc'] = '<i><b>&emsp;Off</b></i> :&emsp;No news will be shown.
<br /><i><b>&emsp;Random</b></i> :&emsp;One news item shown, chosen at random.
<br /><i><b>&emsp;Fader</b></i> :&emsp;All news items are displayed sequentially.';
...
$txt['header_logo_url'] = '<u>Logo Image URL</u>';
$txt['header_logo_url_desc'] = '<i>(leave blank to show forum name or default logo)</i>';
$txt['number_recent_posts'] = 'Number of recent posts to display on board index:';
$txt['number_recent_posts_desc'] = '<i>(to disable the recent posts bar set this value to zero)</i>';
$txt['hide_post_group'] = 'Hide post group titles for grouped members';
$txt['hide_post_group_desc'] = '<i>(when enabled, post count based group titles are not displayed on the message view if they are assigned to a non-post based group)</i>';
...
$txt['themeadmin_list_theme_dir'] = 'Theme directory: <i>(templates)</i>';
...
$txt['themeadmin_reset_tip'] = 'Each theme may have its own custom options for selection by your members.  These include options like &quot;quick reply&quot;, avatars and signatures, layout options, and other similar options.  Here you can change the defaults or reset everyone\'s options.<br />Please note that some themes may use the <i><u>default theme options</u></i>, in which case they will not have their own options.';
