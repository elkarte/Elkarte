...
$txt['smiley_sets_ext'] = 'Set Type';
$txt['smiley_sets_url'] = 'URL';
$txt['smiley_sets_default'] = 'Smiley Set';
$txt['smiley_sets_preview'] = 'Preview';
...
$txt['smileys_add_upload_for'] = 'Image for the <strong>%1$s</strong> set';
...
$txt['smiley_settings_desc'] = 'These settings allow you to change the default smiley set, allow people to select their own smileys, and set paths and configuration data.';
$txt['smiley_editsets_desc'] = 'Smiley Sets are groups of smileys your users can choose between.  For example, you might have yellow and red smileys.<br />Here you can change the name and location of each smiley set - remember, however, that all sets share the same smileys.';
$txt['smiley_editsmileys_desc'] = 'Change your smileys here by clicking on the smiley you want to modify. Remember that these smileys all have to exist in all the sets or some smileys won\'t show up.  Don\'t forget to save after you are done editing.';
$txt['smiley_setorder_desc'] = 'Change the order of the smileys here.';
$txt['smiley_addsmiley_desc'] = 'Here you can add a new smiley - either from an existing file or by uploading new ones.';
...
$txt['smileys_emoji_found'] = 'The alternative %1$s will be used';
