...
$txt['enableUsersMentions'] = 'Enable mention of users with @';
$txt['enableUsersMentions_desc'] = '0 for no max.';
$txt['max_mentioned_members'] = 'Maximum number of members that can be mentioned in one message';
