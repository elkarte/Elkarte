...
class Unread_Controller extends Action_Controller
{
	...
	public function action_unread()
	{
		...
		$context['topics'] = $this->_grabber->getUnreads($type, $_REQUEST['start'], $context['topics_per_page'], !empty($settings['avatars_on_indexes']) ? $settings['avatars_on_indexes'] : 0);
	...
	public function action_unreadreplies()
	{
		...
		$context['topics'] = $this->_grabber->getUnreads(null, $_REQUEST['start'], $context['topics_per_page'], !empty($settings['avatars_on_indexes']) ? $settings['avatars_on_indexes'] : 0);
