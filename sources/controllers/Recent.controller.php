...
class Recent_Controller extends Action_Controller
{
	...
	public function action_unread()
	{
		...
		if ($context['showing_all_topics'])
		{
			...
			$txt['unread_topics_visit_none'] = str_replace('{unread_all_url}', $scripturl . '?action=unread;all');
		}
		else
			$txt['unread_topics_visit_none'] = str_replace('{unread_all_url}', $scripturl . '?action=unread;all' . sprintf($context['querystring_board_limits'], 0) . $context['querystring_sort_limits']);
