...
$txt['age'] = 'Age';
$txt['no_pic'] = '(no pic)';
$txt['avatar_by_url'] = 'Specify your own avatar by URL. (e.g.: <em>https://www.mypage.com/mypic.png</em>)';
...
$txt['notification_settings_info'] = 'This area allows you to define how you want to be notified when someone likes, quotes, mentions, etc. your posts.';
$txt['notify_from'] = 'Receive notifications from:';
$txt['notify_from_description'] = 'This setting applies to the below notifications.';
...
$txt['notify_important_email'] = 'Receive site newsletters and announcements by email.';
$txt['notify_regularity'] = 'For topics and boards I\'ve subscribed to, notify me via:';
$txt['notify_regularity_none'] = 'Never';
$txt['notify_regularity_onsite'] = 'On-site Mention - but only for the first unread reply';
$txt['notify_regularity_instant'] = 'Immediate Email';
$txt['notify_regularity_first_only'] = 'Immediate Email - but only for the first unread reply';
$txt['notify_regularity_daily'] = 'Daily';
$txt['notify_regularity_weekly'] = 'Weekly';
$txt['auto_notify'] = 'Auto subscribe to topics that you start or post in.';
$txt['notify_send_types'] = 'For topics and boards I\'ve subscribed, notify me on:';
...
$txt['notify_send_body'] = 'Send the full text of the post in the email';
$txt['notify_send_body_pbe_post'] = '<strong>NOT</strong> available with Daily / Weekly summary';
$txt['notify_topic_board'] = 'Topic and Board Subscriptions';
...
$txt['notification_info'] = 'This allows you to be notified of replies to posts, newly posted topics, and forum announcements. You can change adjust the delivery method, and the frequency of these notifications. You can also oversee the topics and boards for which you are currently receiving notifications.';
