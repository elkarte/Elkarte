...
function template_error_log()
{
	...
	{
		$error_types[] = ($details['is_selected'] ? '<i class="icon i-directory"></i>' : '') . '<a href="' . $details['url'] . '" ' . ($details['is_selected'] ? 'class="selected"' : '') . ' title="' . $details['description'] . '">' . $details['label'] . '</a>';
	}
