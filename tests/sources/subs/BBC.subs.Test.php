...
Should be an empty line in between.',
			...
			array(
				...
				'<blockquote class="bbc_quote"><cite>Quote</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 1 bis',
				'[quote]This is a quote[quote]of a quote[/quote][/quote]',
				'<blockquote class="bbc_quote"><cite>Quote</cite>This is a quote<div class="quoteheader bbc_alt_quoteheader">Quote</div><blockquote class="bbc_quote bbc_alternate_quote">of a quote</blockquote></blockquote>',
			),
			array(
				'Quoting is a pain 2',
				'[quote author=unquoted author]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite>Quote from: unquoted author</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 3',
				'[quote author=&quot;quoted author&quot;]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite>Quote from: quoted author</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 4',
				'[quote author=q]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite>Quote from: q</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 5',
				...
				'<blockquote class="bbc_quote"><cite>Quote from: qwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuioplkjhgfdsazxcvbnmqwertyuiop</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 6',
				'[quote=something]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite>Quote from: something</cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 7',
				'[quote author=an author link=board=1;topic=123 date=12345678]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite><a href="http://127.0.0.1/index.php?topic=123">Quote from: an author on -' . htmlTime(12345678) . '</a></cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 8',
				'[quote author=an author link=topic=123.msg123#msg123 date=12345678]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite><a href="http://127.0.0.1/index.php?topic=123.msg123#msg123">Quote from: an author on -' . htmlTime(12345678) . '</a></cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 9',
				'[quote author=an author link=threadid=123.msg123#msg123 date=12345678]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite><a href="http://127.0.0.1/index.php?threadid=123.msg123#msg123">Quote from: an author on -' . htmlTime(12345678) . '</a></cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 10',
				'[quote author=an author link=action=profile;u=123 date=12345678]This is a quote[/quote]',
				'<blockquote class="bbc_quote"><cite><a href="http://127.0.0.1/index.php?action=profile;u=123">Quote from: an author on -' . htmlTime(12345678) . '</a></cite>This is a quote</blockquote>',
			),
			array(
				'Quoting is a pain 11',
				'[quote author=an author date=1486679559 link=msg=123][quote]This is a quote[/quote]Of a quote[/quote]',
				'<blockquote class="bbc_quote"><cite><a href="http://127.0.0.1/index.php?msg=123">Quote from: an author on -' . htmlTime(1486679559) . '</a></cite><blockquote class="bbc_quote bbc_alternate_quote"><cite>Quote</cite>This is a quote</blockquote>Of a quote</blockquote>',
			),
			array(
