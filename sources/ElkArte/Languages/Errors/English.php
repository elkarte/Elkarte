...
$txt['registration_privacy_policy_missing'] = 'The privacy policy file is either missing or empty.  Registrations will be disabled until this is fixed';
...
$txt['invalid_access'] = 'The IP (%1$s) was blocked by %2$s check.';
...
$txt['post_upload_error'] = 'The upload data is missing. This error could be caused by trying to submit a file larger than allowed by the server.  Please contact your administrator if this problem continues.';
...
$txt['error_invalid_search_daemon'] = 'Unable to access the search results';
