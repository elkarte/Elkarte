...
$helptxt['allow_no_censored'] = 'This global setting when checked, allows members to disable word censoring in their User Profile through the Look and Layout settings. The members ablility to disable word censoring is still limited by their permission profile. Forbiding the ability to disable word censoring can be used if you know you have children as registered members.';
