...
function template_subject_list()
{
	...
	<div data-role="navbar" data-iconpos="bottom">
		<ul>
			<li>
				<a data-icon="', $dataIcon, '" data-role="button" href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=date', $context['sort_by'] == 'date' && $context['sort_direction'] == 'up' ? ';desc' : '', $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '">', $txt['date'], '</a>
			</li>
			<li>
				<a data-icon="', $dataIcon, '" data-role="button" href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '">', $txt['subject'], '</a>
			</li>
			<li>
				<a data-icon="', $dataIcon, '" data-role="button" href="', $scripturl, '?action=pm;f=', $context['folder'], ';start=', $context['start'], ';sort=name', $context['sort_by'] == 'name' && $context['sort_direction'] == 'up' ? ';desc' : '', $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '">', ($context['from_or_to'] == 'from' ? $txt['from'] : $txt['to']), '</a>
			</li>
		</ul>
	</div>
	<br />
	...
	{
		echo '
		<li', $context['display_mode'] != 0 && $context['current_pm'] == $message['id'] ? ' data-theme="a"' : '', '>
			<script>
		...
		echo '
			...
			<a href="', $scripturl . '?action=pm;pmid=' . $message['id'] . ';kstart;f=' . $context['folder'] . ';start=' . $context['start'] . ';sort=' . $context['sort_by'] . ($context['sort_direction'] == 'up' ? ';' : ';desc') . ($context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : ''), '#msg', $message['id'], '"><h3>', $message['subject'] , ' ', $message['is_unread'] ? '&nbsp;<span class="new">' . $txt['new'] . '</span>' : '', '</h4>
			
			', $message['is_replied_to'] ? '<img src="' . $settings['images_url'] . '/icons/pm_replied.png" style="margin-right: 4px;" alt="' . $txt['pm_replied'] . '" />' : '<img src="' . $settings['images_url'] . '/icons/pm_read.png" style="margin-right: 4px;" alt="' . $txt['pm_read'] . '" />', '
				<p>', $txt['date'], ': ', $message['time'], '</p>
				<p class="ui-li-aside">', ($context['from_or_to'] == 'from' ? $txt['from'] : $txt['to']), ': ', ($context['from_or_to'] == 'from' ? $message['member']['name'] : (empty($message['recipients']['to']) ? '' : implode(', ', $message['recipients']['to']))), '</p>
			
			</a>
			<a data-icon="delete" class="deleteMsg" href="', $scripturl , '?action=pm;sa=pmactions;pm_actions[' , $context['current_pm'] , ']=delete;conversation;f=' , $context['folder'] , ';start=' , $context['start'] , ($context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '') . ';' , $context['session_var'] , '=' , $context['session_id'] , '">', $txt['remove_message'] , '</a>
