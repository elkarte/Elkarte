...
class ParserWrapperTest extends TestCase
{
    ...
    '<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return elkCopyText(this);" class="codeoperation" data-copy="[Copy]" data-copied="Copied!" data-select="[Select]">[Copy]</a></div><pre class="bbc_code prettyprint">This is some code</pre>',
			...
			array(
				...
				'footnote<sup class="bbc_footnotes"><a class="target" href="#fn1_1" id="ref1_1">[1]</a></sup>something<div class="bbc_footnotes"><div class="target" id="fn1_1"><sup>1&nbsp;</sup>footnote <img src="http://127.0.0.1/smileys/default/smiley.svg" alt="&#58;&#41;" title="Smiley" class="smiley" width=48 height=48 /><a class="footnote_return" href="#ref1_1">&crarr;</a></div></div>'			),
			array(
				'Footnote 3',
				'footnote :)[footnote][b]footnote[/b] :)[/footnote]something :)',
				'footnote <img src="http://127.0.0.1/smileys/default/smiley.svg" alt="&#58;&#41;" title="Smiley" class="smiley" width=48 height=48 /><sup class="bbc_footnotes"><a class="target" href="#fn1_2" id="ref1_2">[1]</a></sup>something <img src="http://127.0.0.1/smileys/default/smiley.svg" alt="&#58;&#41;" title="Smiley" class="smiley" width=48 height=48 /><div class="bbc_footnotes"><div class="target" id="fn1_2"><sup>1&nbsp;</sup><strong class="bbc_strong">footnote</strong> <img src="http://127.0.0.1/smileys/default/smiley.svg" alt="&#58;&#41;" title="Smiley" class="smiley" width=48 height=48 /><a class="footnote_return" href="#ref1_2">&crarr;</a></div></div>'
			),
			array(
...
Should be an empty line in between.',
			...
			array(
				...
				'<img src="http://adomain.tld/an_image.png" title="" alt="" style="max-height:100px;" class="bbc_img resized" data-bbcexpandimage="1" />',
			),
			array(
				'Test img 5',
				'[img height=100 width=150]http://adomain.tld/an_image.png[/img]',
				'<img src="http://adomain.tld/an_image.png" title="" alt="" style="width:100%;max-width:150px;max-height:100px;" class="bbc_img resized" data-bbcexpandimage="1" />',
			),
			array(
				'Test img 6',
				'[img alt=some text width=150 height=100]http://adomain.tld/an_image.png[/img]',
				'<img src="http://adomain.tld/an_image.png" title="" alt="some text" style="width:100%;max-width:150px;max-height:100px;" class="bbc_img resized" data-bbcexpandimage="1" />',
			),
			array(
				'Test img 7',
				'[img width=150 height=100 title=some text]http://adomain.tld/an_image.png[/img]',
				'<img src="http://adomain.tld/an_image.png" title="some text" alt="" style="width:100%;max-width:150px;max-height:100px;" class="bbc_img resized" data-bbcexpandimage="1" />',
			),
			array(
				'Test img 8',
				'[img alt=alt8 width=150 height=100 title=some text]http://adomain.tld/an_image.png[/img]',
				'<img src="http://adomain.tld/an_image.png" title="some text" alt="alt8" style="width:100%;max-width:150px;max-height:100px;" class="bbc_img resized" data-bbcexpandimage="1" />',
			),
			array(
				'Unnamed iurl links',
			...
			array(
				...
				'<div class="quote-read-more"><input type="checkbox" aria-label="show" class="quote-show-more"><blockquote class="bbc_quote"><cite>Quote</cite>This is a quote</blockquote></div>',
			),
			array(
				'Quoting is a pain 2',
				'[quote]This is a quote[quote]of a quote[/quote][/quote]',
				'<div class="quote-read-more"><input type="checkbox" aria-label="show" class="quote-show-more"><blockquote class="bbc_quote"><cite>Quote</cite>This is a quote<blockquote class="bbc_quote bbc_alternate_quote"><cite>Quote</cite>of a quote</blockquote></blockquote></div>',
			),
			array(
				'Quoting is a pain 3',
				'[quote author=unquoted author]This is a quote[/quote]',
				'<div class="quote-read-more"><input type="checkbox" aria-label="show" class="quote-show-more"><blockquote class="bbc_quote"><cite>Quote from: unquoted author</cite>This is a quote</blockquote></div>',
			),
			array(
				'Quoting is a pain 4',
				'[quote author=&quot;quoted author&quot;]This is a quote[/quote]',
				'<div class="quote-read-more"><input type="checkbox" aria-label="show" class="quote-show-more"><blockquote class="bbc_quote"><cite>Quote from: quoted author</cite>This is a quote</blockquote></div>',
			),
			array(
				'Quoting is a pain 5',
				'[quote author=q]This is a quote[/quote]',
				'<div class="quote-read-more"><input type="checkbox" aria-label="show" class="quote-show-more"><blockquote class="bbc_quote"><cite>Quote from: q</cite>This is a quote</blockquote></div>',
			),
			array(
				'Quoting is a pain 6',
			...
			array(
				'Smiley',
				':)',
				'<img src="http://127.0.0.1/smileys/default/smiley.svg" alt="&#58;&#41;" title="Smiley" class="smiley" width=48 height=48 />',
			),
			array(
				'Strike',
				'[s]ElkArte[/s]',
