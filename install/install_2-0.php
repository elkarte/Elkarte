	...
	public function insert_calendar_holidays()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array('Summer Solstice', '2021-06-21'),
				...
				array('Vernal Equinox', '2021-03-20'),
				...
				array('Winter Solstice', '2021-12-21'),
				...
				array('Autumnal Equinox', '2021-09-22'),
		...
		return $this->db->insert('ignore',
			...
			array(
				...
				array(
					...
					'can_search' => 0,
					'default_value' => '',
					'enclose' => '<a target="_blank" href="https://www.x.com/{INPUT}" class="icon i-twitter icon-big" title="Twitter Profile"><s>Twitter Profile</s></a>',
					'placement' => 1,
					'rows' => 0,
					'cols' => 0
				),
	...
	public function insert_settings()
	{
		return $this->db->insert('',
			...
			array(
				...
				array('avatar_max_height', '120'),
				array('avatar_max_width', '120'),
