...
$txt['jquery_version'] = 'Enter the version number to use, e.g. 1.10.2';
$txt['jquery_default'] = 'Specify a version of jQuery to use with ElkArte';
$txt['jqueryui_default'] = 'Specify a version of jQuery UI to use with ElkArte';
$txt['jquery_custom_after'] = 'This will look for the local file jquery-<strong>X.XX.X</strong>.min.js';
$txt['jqueryui_custom_after'] = 'This will look for the local file jquery-ui-<strong>X.XX.X</strong>.min.js';
...
$txt['make_email_viewable'] = 'Enable form mailer';
