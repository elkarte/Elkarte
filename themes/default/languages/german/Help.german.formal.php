...
$helptxt['attachment_transfer_empty'] = 'Aktivieren Sie dies, so werden alle Dateien aus dem Quellverzeichnis an den neuen Ort verschoben, andernfalls werden nur so viele Dateien verschoben, wie anhand der Begrenzung pro Verzeichnis erlaubt ist.';
