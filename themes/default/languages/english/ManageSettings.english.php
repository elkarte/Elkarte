...
$txt['custom_edit_options_desc'] = 'Leave value box blank to remove. Radio button selects default option. Key is a unique identifier that will not change even if the value changes, makes it easier to style and reference the value.';
...
$txt['custom_edit_key'] = 'Key';
$txt['custom_edit_value'] = 'Value';
