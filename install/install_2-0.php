...
class InstallInstructions_install_2_0
{
	...
	public function insert_calendar_holidays()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array('Canada Day', '0004-07-01'),
				array('Groundhog Day', '0004-02-02'),
				array("Mother's Day", '2022-05-08'),
				array("Mother's Day", '2023-05-14'),
				array("Mother's Day", '2024-05-12'),
				array("Mother's Day", '2025-05-11'),
				array("Mother's Day", '2026-05-10'),
				array("Mother's Day", '2027-05-09'),
				array("Mother's Day", '2028-05-14'),
				array("Mother's Day", '2029-05-13'),
				array("Mother's Day", '2030-05-12'),
				array("Father's Day", '2022-06-19'),
				array("Father's Day", '2023-06-18'),
				array("Father's Day", '2024-06-16'),
				array("Father's Day", '2025-06-15'),
				array("Father's Day", '2026-06-21'),
				array("Father's Day", '2027-06-20'),
				array("Father's Day", '2028-06-18'),
				array("Father's Day", '2029-06-17'),
				array("Father's Day", '2030-06-16'),
				array('Summer Solstice', '2022-06-21'),
				array('Summer Solstice', '2023-06-21'),
				array('Summer Solstice', '2024-06-20'),
				array('Summer Solstice', '2025-06-21'),
				array('Summer Solstice', '2026-06-21'),
				array('Summer Solstice', '2027-06-21'),
				array('Summer Solstice', '2028-06-20'),
				array('Summer Solstice', '2029-06-21'),
				array('Summer Solstice', '2030-06-21'),
				array('Vernal Equinox', '2022-03-20'),
				array('Vernal Equinox', '2023-03-20'),
				array('Vernal Equinox', '2024-03-20'),
				array('Vernal Equinox', '2025-03-20'),
				array('Vernal Equinox', '2026-03-20'),
				array('Vernal Equinox', '2027-03-20'),
				array('Vernal Equinox', '2028-03-20'),
				array('Vernal Equinox', '2029-03-20'),
				array('Vernal Equinox', '2030-03-20'),
				array('Winter Solstice', '2022-12-21'),
				array('Winter Solstice', '2023-12-22'),
				array('Winter Solstice', '2024-12-21'),
				array('Winter Solstice', '2025-12-21'),
				array('Winter Solstice', '2026-12-21'),
				array('Winter Solstice', '2027-12-22'),
				array('Winter Solstice', '2028-12-21'),
				array('Winter Solstice', '2029-12-21'),
				array('Winter Solstice', '2030-12-21'),
				array('Autumnal Equinox', '2022-09-23'),
				array('Autumnal Equinox', '2023-09-23'),
				array('Autumnal Equinox', '2024-09-22'),
				array('Autumnal Equinox', '2025-09-22'),
				array('Autumnal Equinox', '2026-09-23'),
				array('Autumnal Equinox', '2027-09-23'),
				array('Autumnal Equinox', '2028-09-22'),
				array('Autumnal Equinox', '2029-09-22'),
				array('Autumnal Equinox', '2030-09-22'),
				array('Thanksgiving', '2022-11-24'),
				array('Thanksgiving', '2023-11-23'),
				array('Thanksgiving', '2024-11-28'),
				array('Thanksgiving', '2025-11-27'),
				array('Thanksgiving', '2026-11-26'),
				array('Thanksgiving', '2027-11-25'),
				array('Thanksgiving', '2028-11-23'),
				array('Thanksgiving', '2029-11-22'),
				array('Thanksgiving', '2030-11-28'),
				array('Memorial Day', '2022-05-30'),
				array('Memorial Day', '2023-05-28'),
				array('Memorial Day', '2024-05-27'),
				array('Memorial Day', '2025-05-26'),
				array('Memorial Day', '2026-05-25'),
				array('Memorial Day', '2027-05-31'),
				array('Memorial Day', '2028-05-29'),
				array('Memorial Day', '2029-05-28'),
				array('Memorial Day', '2030-05-27'),
				array('Labor Day', '2022-09-05'),
				array('Labor Day', '2023-09-04'),
				array('Labor Day', '2024-09-02'),
				array('Labor Day', '2025-09-01'),
				array('Labor Day', '2026-09-07'),
				array('Labor Day', '2027-09-06'),
				array('Labor Day', '2028-09-04'),
				array('Labor Day', '2029-09-03'),
				array('Labor Day', '2030-09-02'),
			),
			array('id_holiday')
		);
	}
	...
	public function table_custom_fields()
	{
		return $this->table->create_table('{db_prefix}custom_fields',
			array(
				...
				array('name' => 'col_name', 'type' => 'varchar', 'default' => '', 'size' => 18),
	...
	public function insert_custom_fields()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array(
					'col_name' => 'cust_twitt',
					'field_name' => 'X/Twitter Profile',
					'field_desc' => 'Enter your X/Twitter username.',
					'field_type' => 'text',
					'field_length' => 50,
					'field_options' => '',
					'mask' => 'regex~[a-z][0-9a-z.-]{1,31}~i',
					...
					'can_search' => 0,
					'default_value' => '',
					'enclose' => '<a target="_blank" href="https://www.x.com/{INPUT}" class="icon i-x icon-big" title="Twitter Profile"><s>Twitter Profile</s></a>',
					'placement' => 1,
					'rows' => 0,
					'cols' => 0
				),
	...
	public function insert_settings()
	{
		return $this->db->insert('',
			...
			array(
				...
				array('pollMode', '1'),
				array('modules_display', 'metadata,mentions,poll,verification,random,attachments'),
				...
				array('attachmentDirSizeLimit', '51200'),
				array('attachmentDirFileLimit', '5000'),
				array('attachmentUploadDir', '{BOARDDIR}/attachments'),
				array('automanage_attachments', '2'),
				array('attachmentExtensions', 'doc,xls,bmp,gif,jpg,jpeg,webp,mpg,mp4,mp3,pdf,png,txt,zip,gz,svg'),
				...
				array('attachment_image_resize_width', '2048'),
				array('attachment_image_resize_height', '2048'),
				...
				array('xmlnews_enable', '0'),
				array('xmlnews_limit', '10'),
				array('xmlnews_maxlen', '1024'),
				array('hotTopicPosts', '15'),
				array('hotTopicVeryPosts', '25'),
				array('registration_method', '2'),
				array('send_validation_onChange', '0'),
				array('send_welcomeEmail', '1'),
				array('allow_editDisplayName', '1'),
				array('admin_session_lifetime', '15'),
				array('allow_hideOnline', '0'),
				...
				array('custom_avatar_dir', '{BOARDDIR}/avatars_user'),
				array('custom_avatar_url', '{$boardurl}/avatars_user'),
				array('avatar_max_height', '128'),
				array('avatar_max_width', '128'),
				...
				array('removeNestedQuotes', '1'),
				array('heightBeforeShowMore', '155'),
				array('enablePostMarkdown', '1'),
				array('enableCodePrettify', '1'),
				array('show_user_images', '1'),
				array('enableVideoEmbeding', '1'),
				array('video_embed_limit', '5'),
				array('signature_max_lines', '6'),
				array('signature_max_font_size', '16'),
	...
	public function insert_smileys()
	{
		return $this->db->insert('ignore',
			...
			array(
				// Shown in editor
				array(':smiley:', 'smiley', '{$default_smiley_smiley}', 0, 0),
				array(':wink:', 'wink', '{$default_wink_smiley}', 1, 0),
				array(':cheesy:', 'cheesy', '{$default_cheesy_smiley}', 2, 0),
				array(':grin:', 'grin', '{$default_grin_smiley}', 3, 0),
				array(':angry:', 'angry', '{$default_angry_smiley}', 4, 0),
				array(':sad:', 'sad', '{$default_sad_smiley}', 5, 0),
				array(':shocked:', 'shocked', '{$default_shocked_smiley}', 6, 0),
				array(':cool:', 'cool', '{$default_cool_smiley}', 7, 0),
				array(':huh:', 'huh', '{$default_huh_smiley}', 8, 0),
				array(':rolleyes:', 'rolleyes', '{$default_roll_eyes_smiley}', 9, 0),
				array(':tongue:', 'tongue', '{$default_tongue_smiley}', 10, 0),
				array(':embarrassed:', 'embarrassed', '{$default_embarrassed_smiley}', 11, 0),
				array(':zipper_mouth:', 'lipsrsealed', '{$default_lips_sealed_smiley}', 12, 0),
				array(':undecided:', 'undecided', '{$default_undecided_smiley}', 13, 0),
				array(':kiss:', 'kiss', '{$default_kiss_smiley}', 14, 0),
				array(':cry:', 'cry', '{$default_cry_smiley}', 15, 0),
				// Shown in editor Popup
				array(':evil:', 'evil', '{$default_evil_smiley}', 16, 2),
				array(':laugh:', 'laugh', '{$default_laugh_smiley}', 17, 2),
				array(':rotating_light:', 'police', '{$default_police_smiley}', 18, 2),
				array(':innocent:', 'angel', '{$default_angel_smiley}', 19, 2),
				array(':thumbsup:', 'thumbsup', '{$default_thumbup_smiley}', 20, 2),
				array(':thumbsdown:', 'thumbsdown', '{$default_thumbdown_smiley}', 21, 2),
				array(':skull:', 'skull', '{$default_skull_smiley}', 22, 2),
				array(':poop:', 'poop', '{$default_poop_smiley}', 23, 2),
				array(':sweat:', 'sweat', '{$default_sweat_smiley}', 24, 2),
				array(':heart_eyes:', 'heart', '{$default_heart_smiley}', 25, 2),
				array(':grimacing:', 'grimacing', '{$default_grimace_smiley}', 26, 2),
				array(':nerd:', 'nerd', '{$default_nerd_smiley}', 27, 2),
				array(':head_bandage:', 'clumsy', '{$default_clumsy_smiley}', 28, 2),
				array(':clown:', 'clown', '{$default_clown_smiley}', 29, 2),
				array(':partying_face', 'party', '{$default_party_smiley}', 30, 2),
				array(':zany_face:', 'zany', '{$default_wild_smiley}', 31, 2),
				array(':shushing_face:', 'shh', '{$default_shh_smiley}', 32, 2),
				array(':face_vomiting:', 'vomit', '{$default_vomit_smiley}', 33, 2),
				// Not shown but available for use in messages
				array(':)', 'smiley', '{$default_smiley_smiley}', 34, 1),
				array(';)', 'wink', '{$default_wink_smiley}', 35, 1),
				array(':D', 'cheesy', '{$default_cheesy_smiley}', 36, 1),
				array(';D', 'grin', '{$default_grin_smiley}', 37, 1),
				array('>:(', 'angry', '{$default_angry_smiley}', 38, 1),
				array(':(', 'sad', '{$default_sad_smiley}', 39, 1),
				array(':o', 'shocked', '{$default_shocked_smiley}', 40, 1),
				array('8)', 'cool', '{$default_cool_smiley}', 41, 1),
				array('???', 'huh', '{$default_huh_smiley}', 42, 1),
				array('::)', 'rolleyes', '{$default_roll_eyes_smiley}', 43, 1),
				array(':P', 'tongue', '{$default_tongue_smiley}', 44, 1),
				array(':-[', 'embarrassed', '{$default_embarrassed_smiley}', 45, 1),
				array(':-X', 'lipsrsealed', '{$default_lips_sealed_smiley}', 46, 1),
				array(':-\\', 'undecided', '{$default_undecided_smiley}', 47, 1),
				array(':-*', 'kiss', '{$default_kiss_smiley}', 48, 1),
				array(":'(", 'cry', '{$default_cry_smiley}', 49, 1),
				array('>:D', 'evil', '{$default_evil_smiley}', 50, 1),
	...
	public function insert_spiders()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array('InternetArchive', 'ia_archiver', ''),
