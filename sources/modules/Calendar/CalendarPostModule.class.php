...
class Calendar_Post_Module extends ElkArte\sources\modules\Abstract_Module
{
	...
	private function _prepareEventContext($event_id)
	{
		...
		$context['event']['last_day'] = (int) elk_strftime('%d', mktime(0, 0, 0, $context['event']['month'] == 12 ? 1 : $context['event']['month'] + 1, 0, $context['event']['month'] == 12 ? $context['event']['year'] + 1 : $context['event']['year']));
