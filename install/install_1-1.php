	...
	public function insert_custom_fields()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array('cust_skye', 'Skype', 'This is your Skype account name', 'text', 32, '', 'regex~[a-z][0-9a-z.-]{1,31}~i', 0, 1, 'forumprofile', 0, 1, 0, 0, '', '<a href="skype:{INPUT}?call" class="icon i-skype" title="Skype call {INPUT}"><s>Skype call {INPUT}</s></a>', 1, 0, 0),
				array('cust_fbook', 'Facebook Profile', 'Enter your Facebook username.', 'text', 50, '', 'regex~[a-z][0-9a-z.-]{1,31}~i', 0, 1, 'forumprofile', 0, 1, 0, 0, '', '<a target="_blank" href="https://www.facebook.com/{INPUT}" class="icon i-facebook"><s>Facebook</s></a>', 1, 0, 0),
				array('cust_twitt', 'Twitter Profile', 'Enter your Twitter username.', 'text', 50, '', 'regex~[a-z][0-9a-z.-]{1,31}~i', 0, 1, 'forumprofile', 0, 1, 0, 0, '', '<a target="_blank" href="https://www.twitter.com/{INPUT}" class="icon i-twitter"><s>Twitter Profile</s></a>', 1, 0, 0),
				array('cust_linked', 'LinkedIn Profile', 'Set your LinkedIn Public profile link. You must set a Custom public url for this to work.', 'text', 255, '', 'nohtml', 0, 1, 'forumprofile', 0, 1, 0, 0, '', '<a href="{INPUT}" class="icon i-linkedin"><s>Linkedin Profile</s></a>', 1, 0, 0),
				array('cust_gplus', 'Google+ Profile', 'This is your Google+ profile url.', 'text', 255, '', 'nohtml', 0, 1, 'forumprofile', 0, 1, 0, 0, '', '<a target="_blank" href="{INPUT}" class="icon i-google-plus"><s>G+ Profile</s></a>', 1, 0, 0),
