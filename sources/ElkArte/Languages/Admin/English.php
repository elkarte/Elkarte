...
$txt['attachment_remove_size'] = 'Remove attachments larger than %1$s KB';
...
$txt['attachment_postsize_warning'] = 'The current system settings do not support this.';
...
$txt['attachment_webp_enable'] = 'Enable WebP Conversion';
$txt['attachment_webp_enable_na'] = '(WebP support is not available on this server)';
$txt['attachment_heic_enable'] = 'Enable HEIC->JPG Conversion';
$txt['attachment_heic_enable_na'] = '(HEIC support is not available on this server)';
$txt['attachment_image_adjust'] = 'Attachment Adjustments';
...
$txt['zero_for_system_limit'] = '(Enter 0 to use system limit of %1$s, set by php.ini "%2$s")';
$txt['none'] = 'none';

$txt['attachment_image_resize'] = 'Attachment Image Resizing';
$txt['attachment_image_resize_enabled'] = 'Enable Attachment Image Resizing';
$txt['attachment_image_resize_width'] = 'Maximum allowed width of attached images.';
$txt['attachment_image_resize_height'] = 'Maximum allowed height of attached images.';
$txt['attachment_image_resize_reformat'] = 'Allow images to be reformatted to WebP or JPG';
$txt['attachment_image_resize_post'] = '(larger images will be resized to this limit)';
...
$txt['attach_dir_save_problem'] = 'There seems to be a problem.';
...
$txt['attach_dir_duplicate_file'] = 'Unable to add. A file with this name already exists at this location.';
...
$txt['avatar_max_width'] = 'Maximum width of avatars';
$txt['avatar_max_height'] = 'Maximum height of avatars';
$txt['avatar_action_too_large'] = 'If the avatar is too large...';
$txt['option_refuse'] = 'Refuse it';
$txt['option_resize'] = 'Let the viewers browser resize it';
...
$txt['gravatar_as_default'] = 'Use a default gravatar image for all users without their own avatar.';
$txt['gravatar_rating'] = 'Gravatar Rating';
$txt['gravatar_default'] = 'Default set to use when an email address has no matching Gravatar';
...
$txt['avatar_img_enc_warning'] = 'Neither the GD module nor ImageMagick are installed. Some avatar features are disabled.';
...
$txt['avatar_server_stored'] = 'Server supplied avatars';
...
$txt['enableKlipy'] = 'Enable the Klipy plugin';
$txt['klipyApiKey'] = 'Enter you Klipy API key';
$txt['klipyRating'] = 'Permitted Klipy content filter';
$txt['klipyLanguage'] = 'Klipy language code, defaults to en';
$txt['klipyLanguageURL'] = '<a href="https://klipy.com/docs#overview">Language Codes</a>';
$txt['klipyApiURL'] = '<a href="https://klipy.com/login?redirect=https%3A%2F%2Fpartner.klipy.com">Request API Key</a>';
