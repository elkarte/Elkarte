						...
						<div class="postarea">
							<div class="keyinfo">
								...
								<h5 id="subject_', $message['id'], '">
									<a href="', $message['href'], '" rel="nofollow" title="', !empty($message['counter']) ? sprintf($txt['reply_number'], $message['counter']) : '', ' - ', $message['subject'], '">', $message['timestamp'] < time() - 604800 ? $message['time'] : $message['subject'] , '</a>';
