...
$txt['maillist_imap_host_desc'] = 'Enter a server name, optional port, and mailbox where the mail is located. For example: {imap.gmail.com:993/ssl/novalidate-cert}INBOX';
...
$txt['maillist_imap_reason'] = 'The following should be left <strong>empty</strong> if you intend to pipe messages into the forum (recommended)';
