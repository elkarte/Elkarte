...
function template_main()
{
	...
	<div id="board_', $context['current_board'], '_childboards" class="boardindex_table">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if ($board['can_approve_posts'] && ($board['unapproved_posts'] || $board['unapproved_topics']))
				echo '
						<a href="', $scripturl, '?action=moderate;area=postmod;sa=', ($board['unapproved_topics'] > 0 ? 'topics' : 'posts'), ';brd=', $board['id'], ';', $context['session_var'], '=', $context['session_id'], '" title="', sprintf($txt['unapproved_posts'], $board['unapproved_topics'], $board['unapproved_posts']), '" class="moderation_link"><img src="', $settings['images_url'], '/icons/field_invalid.png" title="', sprintf($txt['unapproved_posts'], $board['unapproved_topics'], $board['unapproved_posts']), '" alt="(!)" /></a>';
	...
	<div class="tborder topic_table" id="messageindex">
		...
		// @todo There is trial code here to hide the topic icon column. Colspan can be cleaned up later.
		...
		foreach ($context['topics'] as $topic)
		{
			...
			// @todo There is trial code here to hide the topic icon column. Hardly anyone will miss it.
			// @todo Markup can be cleaned up later. CSS can go in the CSS files later.
			echo '
				<tr>
			...
			echo '
					...
					<td class="', $alternate_class, ' lastpost">
						', $topic['last_post']['time'], '<a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.png" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a><br />
