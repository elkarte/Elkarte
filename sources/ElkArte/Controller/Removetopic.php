 ...
 * paraphernalia.  Due to the clever naming, it also handles the restoration of
 * topics and posts from the recycle bin.
 *
...
class Removetopic extends AbstractController
{
	...
	public function action_index()
	{
		...
		$subActions = [
			'deletemsg' => [$this, 'action_deletemsg'],
			'removetopic2' => [$this, 'action_removetopic2'],
			'restoretopic' => [$this, 'action_restoretopic'],
		];

		$action = new Action('removetopic');
	 ...
	 * - Accessed by ?action=removetopic;sa=restoretopic
	 */
