...
$txt['globalCookies'] = 'Use global, subdomain independent cookies';
...
$txt['pwa_settings'] = 'Progressive Web App Settings';
...
$txt['pwa_enabled'] = 'Enable Progressive Web Application (PWA)';
$txt['pwa_disabled'] = 'PWA requires HTTPS/SSL to be enabled';
$txt['pwa_manifest_enabled'] = 'Enable PWA manifest';
$txt['pwa_manifest_enabled_desc'] = 'The manifest provides metadata about your forum when installed as a PWA';
$txt['pwa_short_name'] = 'PWA short name';
$txt['pwa_short_name_desc'] = 'Short name for your forum (max 12 characters, used for icon labels)';
$txt['pwa_theme_color'] = 'PWA theme color';
$txt['pwa_theme_color_desc'] = 'Color that appears in browser UI when your PWA is active';
$txt['pwa_background_color'] = 'PWA background color';
$txt['pwa_background_color_desc'] = 'Background color for the splash screen when loading your PWA';
$txt['pwa_application_icons'] = 'PWA Application Icons';
$txt['pwa_small_icon'] = 'PWA small icon (192x192)';
$txt['pwa_small_icon_desc'] = 'URL to your small PWA icon (recommended size: 192x192 pixels)';
$txt['pwa_large_icon'] = 'PWA large icon (512x512)';
$txt['pwa_large_icon_desc'] = 'URL to your large PWA icon (recommended size: 512x512 pixels)';
$txt['pwa_screenshots_title'] = 'PWA Screenshots';
$txt['pwa_mobile_screenshot'] = 'Mobile screenshot';
$txt['pwa_mobile_screenshot_desc'] = 'URL to a screenshot of your forum on mobile (recommended size: 390x844 pixels)';
$txt['pwa_desktop_screenshot'] = 'Desktop screenshot';
$txt['pwa_desktop_screenshot_desc'] = 'URL to a screenshot of your forum on desktop (recommended size: 1920x1080 pixels)';
$txt['other_icons_title'] = 'Other Icons';
$txt['favicon_icon'] = 'Favicon';
$txt['favicon_icon_desc'] = 'URL to your forum favicon';
$txt['apple_touch_icon'] = 'Apple touch icon';
$txt['apple_touch_icon_desc'] = 'URL to your Apple touch icon for iOS devices';
