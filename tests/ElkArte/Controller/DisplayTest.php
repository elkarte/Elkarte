...
class DisplayTest extends ElkArteCommonSetupTest
{
	...
	public function testActionDisplay()
	{
		...
		$this->assertEquals('Welcome to ElkArte!<br /><br />We hope you enjoy using this software and building your community.&nbsp; If you have any problems, please feel free to <a href="https://www.elkarte.net/community/index.php" class="bbc_link" target="_blank" rel="noopener noreferrer nofollow ugc">ask us for assistance</a>.<br /><br />Thanks!<br />The ElkArte Community.', $message['body']);
	}
}
