...
$helptxt['allow_disableAnnounce'] = 'Allows members to opt out of non-essential forum emails, such as announced topics, newsletters, birthday greetings, and other messages they did not explicitly request. This does not affect essential account-related emails, such as password resets, account activation, etc.<br />Disabling this option prevents members from controlling their email preferences and may violate privacy and anti-spam laws, including the  <a href="https://ec.europa.eu/info/law/law-topic/data-protection/eu-data-protection-rules_en" target="_blank" rel="noopener" class="bbc_link">GDPR</a> and similar regulations in many jurisdictions.';
...
$helptxt['avatar_upload'] = 'This option allows your members to upload an avatars, much like adding an attachment.<br />This provies for better control over the sizing and overall improved serving of avatars. However, the downside is that it takes space on your server.';
