			...
			<div class="windowbg">
				<div class="content">
					<dl class="settings">
						...
						<dt class="large_caption">
							<a href="', $scripturl, '?action=quickhelp;help=search_weight_frequency" onclick="return reqOverlayDiv(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.png" alt="', $txt['help'], '" align="top" /></a><label for="weight6_val">
