...
function template_announce()
{
	...
	echo '
	<div id="announcement">
		<form action="', getUrl('action', ['action' => 'announce', 'sa' => 'send']), '" method="post" accept-charset="UTF-8">
			...
			<div class="content">
				<p>
					', $txt['announce_this_topic'], ' <a href="', getUrl('topic', ['topic' => $context['current_topic'], 'start' => '0']), '">', $context['topic_subject'], '</a>
				</p>
				<ul>';
...
function template_announcement_send()
{
	...
	echo '
	<div id="announcement">
		<form action="' . getUrl('action', ['action' => 'announce', 'sa' => 'send']), '" method="post" accept-charset="UTF-8" name="autoSubmit" id="autoSubmit">
			<div class="content">
