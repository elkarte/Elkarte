...
$txt['new_in_1.0.2'] = 'The most relevant change in ElkArte 1.0.2 is the management of the avatars. Now the different methods of setting an avatar are no more permission-based, but can only be enabled/disabled for all the users and there is only one setting for maximum width and height. The only permission available is a general one to allow members to change or not their avatars.<br /><br />Due to the nature of the changes it has been impossible to migrate any existing setting to the new format, for that reason you are encouraged to visit the <a href="{admin_url};area=manageattachments;sa=avatars">Avatar Settings</a> page and choose the options you prefer.';
