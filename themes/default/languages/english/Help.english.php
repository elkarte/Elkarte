...
$helptxt['avatar_resize_options'] = 'This set of options apply to any "server stored" avatar, either uploaded or retrieved from an external URL.<br />It doesn\'t apply to the &quot;Server-stored avatars&quot; because these are uploaded to the server by the admin via ftp.';
