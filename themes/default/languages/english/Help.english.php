...
$helptxt['minify_css_js'] = 'This will minimize CSS and JavaScript files and inline as needed.  It removes unnecessary whitespace/comments/code from the files to reduce their size.  The minimized files are saved so further requests can instantly serve them.';
...
$helptxt['spider_no_guest'] = 'By selecting this the spider will only be in the restrictive group and have the permissions and board access only of that group (no guest access). You can use this to provide lesser access to a search engine than you would a normal guest. You might for example wish to remove spiders from indexing certain boards while still allowing guest viewing.';
